...
import { AlgoMd5 } from './Response/Model/AlgoMd5';
import { AlgoPhpass } from './Response/Model/AlgoPhpass';
import { AlgoScrypt } from './Response/Model/AlgoScrypt';
import { AlgoScryptModified } from './Response/Model/AlgoScryptModified';
import { AlgoSha } from './Response/Model/AlgoSha';
import { Any } from './Response/Model/Any';
import { Attribute } from './Response/Model/Attribute';
import { AttributeBoolean } from './Response/Model/AttributeBoolean';
import { AttributeDatetime } from './Response/Model/AttributeDatetime';
import { AttributeEmail } from './Response/Model/AttributeEmail';
import { AttributeEnum } from './Response/Model/AttributeEnum';
import { AttributeFloat } from './Response/Model/AttributeFloat';
import { AttributeInteger } from './Response/Model/AttributeInteger';
import { AttributeIP } from './Response/Model/AttributeIP';
import { AttributeList } from './Response/Model/AttributeList';
import { AttributeRelationship } from './Response/Model/AttributeRelationship';
import { AttributeString } from './Response/Model/AttributeString';
import { AttributeURL } from './Response/Model/AttributeURL';
import { AuthProvider } from './Response/Model/AuthProvider';
import { BaseList } from './Response/Model/BaseList';
import { Branch } from './Response/Model/Branch';
import { Bucket } from './Response/Model/Bucket';
import { Build } from './Response/Model/Build';
import { Collection } from './Response/Model/Collection';
import { ConsoleVariables } from './Response/Model/ConsoleVariables';
import { Continent } from './Response/Model/Continent';
import { Country } from './Response/Model/Country';
import { Currency } from './Response/Model/Currency';
import { Database } from './Response/Model/Database';
import { Deployment } from './Response/Model/Deployment';
import { Detection } from './Response/Model/Detection';
import { ModelDocument } from './Response/Model/Document';
import { ErrorModel } from './Response/Model/Error';
import { ErrorDev } from './Response/Model/ErrorDev';
import { Execution } from './Response/Model/Execution';
import { File } from './Response/Model/File';
import { Func } from './Response/Model/Func';
import { Headers } from './Response/Model/Headers';
import { HealthAntivirus } from './Response/Model/HealthAntivirus';
import { HealthCertificate } from './Response/Model/HealthCertificate';
import { HealthQueue } from './Response/Model/HealthQueue';
import { HealthStatus } from './Response/Model/HealthStatus';
import { HealthTime } from './Response/Model/HealthTime';
import { HealthVersion } from './Response/Model/HealthVersion';
import { Identity } from './Response/Model/Identity';
import { Index } from './Response/Model/Index';
import { Installation } from './Response/Model/Installation';
import { JWT } from './Response/Model/JWT';
import { Key } from './Response/Model/Key';
import { Language } from './Response/Model/Language';
import { Locale } from './Response/Model/Locale';
import { LocaleCode } from './Response/Model/LocaleCode';
import { Log } from './Response/Model/Log';
import { Membership } from './Response/Model/Membership';
import { Message } from './Response/Model/Message';
import { Metric } from './Response/Model/Metric';
import { MetricBreakdown } from './Response/Model/MetricBreakdown';
import { MFAChallenge } from './Response/Model/MFAChallenge';
import { MFAFactors } from './Response/Model/MFAFactors';
import { MFARecoveryCodes } from './Response/Model/MFARecoveryCodes';
import { MFAType } from './Response/Model/MFAType';
import { Migration } from './Response/Model/Migration';
import { MigrationFirebaseProject } from './Response/Model/MigrationFirebaseProject';
import { MigrationReport } from './Response/Model/MigrationReport';
import { Mock } from './Response/Model/Mock';
import { None } from './Response/Model/None';
import { Phone } from './Response/Model/Phone';
import { Platform } from './Response/Model/Platform';
import { Preferences } from './Response/Model/Preferences';
import { Project } from './Response/Model/Project';
import { Provider } from './Response/Model/Provider';
import { ProviderRepository } from './Response/Model/ProviderRepository';
import { Rule } from './Response/Model/Rule';
import { Runtime } from './Response/Model/Runtime';
import { Session } from './Response/Model/Session';
import { Subscriber } from './Response/Model/Subscriber';
import { Target } from './Response/Model/Target';
import { Team } from './Response/Model/Team';
import { TemplateEmail } from './Response/Model/TemplateEmail';
import { TemplateSMS } from './Response/Model/TemplateSMS';
import { Token } from './Response/Model/Token';
import { Topic } from './Response/Model/Topic';
import { UsageBuckets } from './Response/Model/UsageBuckets';
import { UsageCollection } from './Response/Model/UsageCollection';
import { UsageDatabase } from './Response/Model/UsageDatabase';
import { UsageDatabases } from './Response/Model/UsageDatabases';
import { UsageFunction } from './Response/Model/UsageFunction';
import { UsageFunctions } from './Response/Model/UsageFunctions';
import { UsageProject } from './Response/Model/UsageProject';
import { UsageStorage } from './Response/Model/UsageStorage';
import { UsageUsers } from './Response/Model/UsageUsers';
import { User } from './Response/Model/User';
import { Variable } from './Response/Model/Variable';
import { Webhook } from './Response/Model/Webhook';
...
export class Response extends TuvalResponse {
    ...
    constructor(response: ExpressResponse) {
        ...
        // Lists
        this.setModel(new BaseList('Documents List', Response.MODEL_DOCUMENT_LIST, 'documents', new ModelDocument()));
        this.setModel(new BaseList('Collections List', Response.MODEL_COLLECTION_LIST, 'collections', new Collection()));
        this.setModel(new BaseList('Databases List', Response.MODEL_DATABASE_LIST, 'databases', new Database()));
        this.setModel(new BaseList('Indexes List', Response.MODEL_INDEX_LIST, 'indexes', new Index()));
        this.setModel(new BaseList('Users List', Response.MODEL_USER_LIST, 'users', new User()));
        this.setModel(new BaseList('Sessions List', Response.MODEL_SESSION_LIST, 'sessions', new Session()));
        this.setModel(new BaseList('Identities List', Response.MODEL_IDENTITY_LIST, 'identities', new Identity()));
        this.setModel(new BaseList('Logs List', Response.MODEL_LOG_LIST, 'logs', new Log()));
        this.setModel(new BaseList('Files List', Response.MODEL_FILE_LIST, 'files', new File()));
        this.setModel(new BaseList('Buckets List', Response.MODEL_BUCKET_LIST, 'buckets', new Bucket()));
        this.setModel(new BaseList('Teams List', Response.MODEL_TEAM_LIST, 'teams', new Team()));
        this.setModel(new BaseList('Memberships List', Response.MODEL_MEMBERSHIP_LIST, 'memberships', new Membership()));
        this.setModel(new BaseList('Functions List', Response.MODEL_FUNCTION_LIST, 'functions', new Func()));
        this.setModel(new BaseList('Installations List', Response.MODEL_INSTALLATION_LIST, 'installations', new Installation()));
        this.setModel(new BaseList('Provider Repositories List', Response.MODEL_PROVIDER_REPOSITORY_LIST, 'providerRepositories', new ProviderRepository()));
        this.setModel(new BaseList('Branches List', Response.MODEL_BRANCH_LIST, 'branches', new Branch()));
        this.setModel(new BaseList('Runtimes List', Response.MODEL_RUNTIME_LIST, 'runtimes', new Runtime()));
        this.setModel(new BaseList('Deployments List', Response.MODEL_DEPLOYMENT_LIST, 'deployments', new Deployment()));
        this.setModel(new BaseList('Executions List', Response.MODEL_EXECUTION_LIST, 'executions', new Execution()));
        this.setModel(new BaseList('Builds List', Response.MODEL_BUILD_LIST, 'builds', new Build())); // Not used anywhere yet
        this.setModel(new BaseList('Projects List', Response.MODEL_PROJECT_LIST, 'projects', new Project(), true, false));
        this.setModel(new BaseList('Webhooks List', Response.MODEL_WEBHOOK_LIST, 'webhooks', new Webhook(), true, false));
        this.setModel(new BaseList('API Keys List', Response.MODEL_KEY_LIST, 'keys', new Key(), true, false));
        this.setModel(new BaseList('Auth Providers List', Response.MODEL_AUTH_PROVIDER_LIST, 'platforms', new AuthProvider(), true, false));
        this.setModel(new BaseList('Platforms List', Response.MODEL_PLATFORM_LIST, 'platforms', new Platform(), true, false));
        this.setModel(new BaseList('Countries List', Response.MODEL_COUNTRY_LIST, 'countries', new Country()));
        this.setModel(new BaseList('Continents List', Response.MODEL_CONTINENT_LIST, 'continents', new Continent()));
        this.setModel(new BaseList('Languages List', Response.MODEL_LANGUAGE_LIST, 'languages', new Language()));
        this.setModel(new BaseList('Currencies List', Response.MODEL_CURRENCY_LIST, 'currencies', new Currency()));
        this.setModel(new BaseList('Phones List', Response.MODEL_PHONE_LIST, 'phones', new Phone()));
        this.setModel(new BaseList('Metric List', Response.MODEL_METRIC_LIST, 'metrics', new Metric(), true, false));
        this.setModel(new BaseList('Variables List', Response.MODEL_VARIABLE_LIST, 'variables', new Variable()));
        this.setModel(new BaseList('Status List', Response.MODEL_HEALTH_STATUS_LIST, 'statuses', new HealthStatus()));
        this.setModel(new BaseList('Rule List', Response.MODEL_PROXY_RULE_LIST, 'rules', new Rule()));
        this.setModel(new BaseList('Locale codes list', Response.MODEL_LOCALE_CODE_LIST, 'localeCodes', new LocaleCode()));
        this.setModel(new BaseList('Provider list', Response.MODEL_PROVIDER_LIST, 'providers', new Provider()));
        this.setModel(new BaseList('Message list', Response.MODEL_MESSAGE_LIST, 'messages', new Message()));
        this.setModel(new BaseList('Topic list', Response.MODEL_TOPIC_LIST, 'topics', new Topic()));
        this.setModel(new BaseList('Subscriber list', Response.MODEL_SUBSCRIBER_LIST, 'subscribers', new Subscriber()));
        this.setModel(new BaseList('Target list', Response.MODEL_TARGET_LIST, 'targets', new Target()));
        this.setModel(new BaseList('Migrations List', Response.MODEL_MIGRATION_LIST, 'migrations', new Migration()));
        this.setModel(new BaseList('Migrations Firebase Projects List', Response.MODEL_MIGRATION_FIREBASE_PROJECT_LIST, 'projects', new MigrationFirebaseProject()));
